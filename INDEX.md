...
- ch77_how_my_web_research_works_deep_research_skeptical_decompose_.md — How my web research works — Deep Research: skeptical decompose → multi-source (arXiv/Crossref/EuropePMC/web) → 3-lens adversaria (781 words, 10 cards) [2026-09-14 07:54]
- ch78_how_my_background_self_learner_works_idle_daemon_that_drives.md — How my background self learner works — Idle daemon that drives self-learning: gap → read cited web → verify → file into RAG → retrieve next (857 words, 12 cards) [2026-09-14 21:10]
- ch79_how_my_council_teach_works_bigger_teacher_models_gemma_llama.md — How my council teach works — Bigger teacher models (Gemma/Llama, permissive-licensed) teach verified facts THROUGH the gate. (818 words, 9 cards) [2026-09-15 14:05]
